...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT(
        ...
        KC_TAB, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                         KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_PGUP, KC_F11,
        KC_LSFT, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,                               KC_HOME, KC_DEL, KC_END, KC_END, KC_PGDN, KC_F12,
        KC_LALT, KC_TRNS, KC_SPC,         KC_ENT, KC_TRNS, KC_RALT
    ),

    [_SYM] = LAYOUT(
        KC_ESC,  KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC,                                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
        KC_LCTL, RGB_TOG, KC_MPLY, KC_MUTE, KC_VOLU, KC_VOLD,                        KC_MINS, KC_EQL, KC_LCBR, KC_RCBR, KC_PIPE, KC_GRV,
        KC_LSFT, KC_CALC, KC_MYCM, KC_MPRV, KC_MNXT, TG(_GAME),                             KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, KC_TILD,
        KC_LALT, KC_TRNS, KC_SPC,       KC_ENT, KC_TRNS, KC_RALT
    ),

    [_GAME] = LAYOUT(
        KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T,                                   KC_F1, KC_F2, KC_UP, KC_F4, KC_F5, KC_F6,
        KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G,                                  KC_F7, KC_LEFT, KC_DOWN, KC_RGHT, KC_F11, KC_F12,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_TRNS,                                KC_PGUP, KC_PGDN, KC_NO, KC_NO, KC_NO, KC_NO,
        MO(_WEAPON), KC_LCTL, KC_SPC,              KC_ENT, KC_TRNS, KC_NO
    ),
